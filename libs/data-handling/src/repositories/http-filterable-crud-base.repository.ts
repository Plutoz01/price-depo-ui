...
export abstract class HttpFilterableCrudBaseRepository<T extends Identifiable<ID>,
  ID,
  FK extends string> extends HttpCrudBaseRepository<T, ID> implements FilterableRepository<T, FK> {
